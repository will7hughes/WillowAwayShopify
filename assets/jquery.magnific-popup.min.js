!(function (e) {
	...
	(y.prototype = {
		...
		_hasScrollBar: function (e) {
			return (
				(t.isIE7 ? i.height() : document.body.scrollHeight) > (e || w.height())
			);
		},
		_setFocus: function () {
	...
	e.magnificPopup.registerModule(R, {
		options: {
			markup:
				'<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameallowfullscreen></iframe></div>',
